...
main:
    ...
    NANOPORE_AMPLICON_CLUSTERING(params.input_fastq_dir, params.primers_fnp, params.genome_dir, params.gff_dir, params.nanopore_primers_errors_allowed, params.meta_fnp)
}
